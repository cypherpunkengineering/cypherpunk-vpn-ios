...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let config = Realm.Configuration(schemaVersion: 11, migrationBlock: {
        ...
        ShortcutHelper.registerShortcutItems(application)
    ...
    func applicationWillResignActive(_ application: UIApplication) {
        ...
        ShortcutHelper.registerShortcutItems(application) // update the shortcut items before the application quits
    }
...
//                    failureBlock()
        ...
        let _ = ShortcutHelper.handleShortCutItem(shortcut)
    ...
    func application(_ application: UIApplication, performActionFor shortcutItem: UIApplicationShortcutItem, completionHandler: @escaping (Bool) -> Void) {
        let handledShortCutItem = ShortcutHelper.handleShortCutItem(shortcutItem)
